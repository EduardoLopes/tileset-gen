  ...
  render: function() {
    ...
    return (
      React.createElement("div", {className: "tilesets-container"}, 
        ...
        React.createElement("button", {onClick: this.download, className: "download"}, "Download")
      )
    );
  }
});
...
var TilesetUpload = React.createClass({displayName: 'TilesetUpload',
  ...
  render: function() {
    return (
      React.createElement("div", {className: "base add", onClick: this.handleAddClick}, 
        "Add a new tileset base", 
        React.createElement("input", {ref: "input", type: "file", accept: "image/*", className: "file-input", onChange: this.handleOnChange})
      )
    );
  }
});
...
var TopBar = React.createClass({displayName: 'TopBar',
  ...
  render: function() {
    ...
    return (
      React.createElement("nav", {className: "top-bar"}, 
        React.createElement("span", {className: "title"}, "Tileset Gen ", React.createElement("sup", null, "Alpha 0.0.9"), "  "), 
...
; browserify_shim__define__module__export__(typeof blob != "undefined" ? blob : window.blob);
